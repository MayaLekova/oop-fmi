...
Засега няма да разглеждаме глобалните статични променливи, тъй като поне до този момент те ще се по същия начин като нестатичните такива. Разлика между двете се появява, когато
програмата ни е разположена в множество файлове (с което ще се занимаваме по-нататък през семестъра).
