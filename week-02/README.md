...
домейн от стойности (само 256) на брой и би било по-добре специално в този случай да използваме counting sort. За момента игнорирайте конкретните имплементации на алгоритмите за сортиране, тъй като те по същество не са част от материала по ООП.
```c++
#include <iostream>
